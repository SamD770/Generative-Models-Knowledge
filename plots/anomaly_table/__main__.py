...
def run(anomaly_detection_name, model_names, id_datasets, dataset_names, batch_size, metric_name):
...
run(args.anomaly_detection, args.model_names, args.id_datasets, args.datasets, args.batch_size, args.metric)
