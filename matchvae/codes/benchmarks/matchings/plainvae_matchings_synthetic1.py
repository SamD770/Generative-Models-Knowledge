...
df_plain_vae_info = pd.read_csv('../../../outputs/sweep_outputs/plainvae_synthetic1_infos.csv')
save_dict_filenames = []

for ID, exp_num in zip(df_plain_vae_info.ID, df_plain_vae_info.synthetic1_seed):
...
for exp_num, save_dict_filename in save_dict_filenames:
    ...
    train_data = Synthetic1(exp_num, n_samples=2000, n_dims_tot=1000, dataset="train", tensor=False, train_size=0.7,
                            val_size=0.)
    test_data = Synthetic1(exp_num, n_samples=2000, n_dims_tot=1000, dataset="test", tensor=False, train_size=0.7,
                           val_size=0.)
...
df_res.to_csv('../../../outputs/matching_benchmark_outputs/plainvae_synthetic1.csv')
