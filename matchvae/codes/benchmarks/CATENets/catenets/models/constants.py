...
DEFAULT_LAYERS_OUT = 3
DEFAULT_LAYERS_OUT_T = 3
DEFAULT_LAYERS_R = 3
DEFAULT_LAYERS_R_T = 3

DEFAULT_UNITS_OUT = 200
DEFAULT_UNITS_R = 200
DEFAULT_UNITS_OUT_T = 200
...
DEFAULT_VAL_SPLIT = 0.3 / (0.4 + 0.3)
DEFAULT_N_ITER_MIN = 0
DEFAULT_PATIENCE = 3
