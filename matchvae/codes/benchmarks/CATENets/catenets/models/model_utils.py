...
def _check_splitted_array(a):
    print('Length {}, Mean {}, Max {}'.format(len(a), a.mean(), a.max()))

def make_val_split(X, y, w=None, val_split_prop: float = DEFAULT_VAL_SPLIT,
                   seed: int = DEFAULT_SEED, stratify_w: bool = False, shuffle = False):
    if val_split_prop == 0:
        ...
        if w is None:
            ...
            _check_splitted_array(X_t)
            _check_splitted_array(X_val)
