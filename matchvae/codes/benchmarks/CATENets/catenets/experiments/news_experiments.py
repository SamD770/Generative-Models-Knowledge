...
def do_news_experiments(n_exp: int = 50, file_name: str = 'results_scaled',
    ...
    for i_exp in experiment_loop:
        ...
        # get data
        data_exp = News(i_exp, dataset="train", tensor=False, train_size=0.7, val_size=0., data_folder=DATA_DIR)
        data_exp_test = News(i_exp, dataset="test", tensor=False, train_size=0.7, val_size=0., data_folder=DATA_DIR)
